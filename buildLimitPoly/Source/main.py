...
#Constants
DEFAULT_IN_PATH         = 'Source/TestDocs/example.txt'
DEFAULT_OUT_PATH        = 'Source/TestDocs/output.txt'
UNIT_TEST1_IN_PATH      = 'Source/TestDocs/test.txt'
UNIT_TEST1_OUT_PATH     = 'Source/TestDocs/testResult.txt'
TEST_OVERLAP_IN_PATH    = 'Source/TestDocs/testOverlap.txt'
TEST_OVERLAP_OUT_PATH   = 'Source/TestDocs/resultsOverlap.txt'
